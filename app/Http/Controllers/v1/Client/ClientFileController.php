...
use App\Actions\v1\Client\File\UploadAction;
use App\Dto\v1\Client\File\UploadDto;
...
class ClientFileController extends Controller
{
     ...
     * @param \App\Actions\v1\Client\File\UploadAction $action
     * @return JsonResponse
     */
     ...
     * @param int $id
     * @param int $fileId
     * @param \App\Actions\v1\Client\File\DownloadAction $action
     ...
     * @param int $id
     * @param int $fileId
     * @param \App\Actions\v1\Client\File\DeleteFileAction $action
     * @return JsonResponse
     */
