...
class StageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Stage::create([
            ...
            'deadline' => now()->addDays(6)->format('m-d-Y'),
            'is_required' => false,
            'created_by' => 1,
            'order' => 5,
            'status' => 'waiting',
        ...
        Stage::create([
            'title' => 'Оплата контракта',
            'description' => 'Получение оплаты от клиента',
            'deadline' => now()->addDays(11)->format('m-d-Y'),
            'is_required' => true,
            'created_by' => 1,
            'order' => 3,
            'status' => 'waiting',
        ...
        Stage::create([
            'title' => 'Закрытие проекта',
            'description' => 'Финальная отчетность и закрытие',
            'deadline' => now()->addDays(12)->format('m-d-Y'),
            'is_required' => true,
            'created_by' => 1,
            'order' => 4,
            'status' => 'waiting',
        ...
        Stage::create([
            'title' => 'Выход на работу',
            'description' => 'Оформление и адаптация новых сотрудников',
            'deadline' => now()->addDays(8)->format('m-d-Y'),
            'is_required' => true,
            'created_by' => 1,
            'order' => 2,
            'status' => 'in_progress',
        ...
        Stage::create([
            'title' => 'Оплата контракта',
            'description' => 'Получение оплаты от клиента',
            'deadline' => now()->addDays(9)->format('m-d-Y'),
            'is_required' => true,
            'created_by' => 1,
            'order' => 3,
            'status' => 'waiting',
